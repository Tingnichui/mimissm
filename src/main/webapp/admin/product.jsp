...
<script type="text/javascript">
                ...
                if(confirm("您确定删除"+zhi.length+"条商品吗？")){
                    ...
                    $.ajax({
                        ...
                        data:{
                            ...
                            "lprice":$.trim($("#lprice").val()),
                            "hprice":$.trim($("#hprice").val())
                        },
                        type:"post",
                        dataType:"text",
    ...
    function one(pid, page) {
        ...
        var str = "&pName=" +pName + "&typeid=" +typeid + "&lprice=" +lprice + "&hprice=" +hprice
        location.href = "${pageContext.request.contextPath}/prod/one.action?pid=" + pid + "&page=" + page + str;
    }
</script>
<!--分页的AJAX实现-->
<script type="text/javascript">
